...
public class QQChatHook implements IXposedHookLoadPackage {
        ...
        findAndHookMethod("com.tencent.mobileqq.data.MessageForQQWalletMsg", loadPackageParam.classLoader, "doParse", new
                XC_MethodHook() {
                    ...
                    protected void afterHookedMethod(MethodHookParam param) throws Throwable {
                        ...
                        Class qqplugin = findClass(QQVersionParam.QQPluginClass, walletClassLoader);
    ...
    public void handleLoadPackage(final XC_LoadPackage.LoadPackageParam loadPackageParam) throws Throwable {
        ...
        if (loadPackageParam.packageName.equals(WeChatHook.WECHAT_PACKAGE_NAME)) {
