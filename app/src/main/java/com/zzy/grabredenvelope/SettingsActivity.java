        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            donateAlipay.setOnPreferenceClickListener(new OnPreferenceClickListener() {
                ...
                public boolean onPreferenceClick(Preference pref) {
                    ...
                    intent.setData(Uri.parse("alipayqr://platformapi/startapp?saId=4227107&clientVersion=3.7.0.0718&qrcode=" + payUrl));
            ...
            Preference wakeupBtn = findPreference("wake_up");
            wakeupBtn.setOnPreferenceClickListener(new OnPreferenceClickListener() {
                @Override
                public boolean onPreferenceClick(Preference pref) {
                    Intent intent = new Intent(SettingsFragment.this.getActivity(), WakeUpService.class);
